...
-- Setting the conceal level to 1 or 2 is mandatory for obsidian.nvim to render checkboxes etc correctly
...
vim.keymap.set('n', '<leader>e', ':NvimTreeToggle<CR>', { desc = 'Open netrw explorer' })
